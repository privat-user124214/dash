...
<body>
    ...
    <main style="text-align: center; padding-top: 100px;">
        ...
        <a href="https://discord.com/oauth2/authorize?client_id=1284484623279067196&permissions=0&response_type=code&redirect_uri=https%3A%2F%2Fdash-k7s3.onrender.com%2Fcallback.php&integration_type=0&scope=identify+email+connections+bot+guilds+applications.commands+guilds.members.read">
